"""Archived differentiable-DP prototype.

This file is retained for research history only. It is not imported by the
current GTG-memory runtime and depends on the removed Graph2Vid-era
``models.model_utils`` module.
"""
